            ...
            <div style="text-align: center;" class="col-xxl-3 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div  class="card-body">
                  ...
                  <div style="margin-left: 25%;" class="d-flex align-items-center">
                    <div style="background-color: rgb(23, 171, 212); color: white; " class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  ...
                  <tr>
                      ...
                      <?php
                            if($rep['status'] =='0'){
                              ...
                              echo "<span class='badge' style='padding:10px; background-color:  rgb(51, 145, 87);'>RESOLVED</span>";
                            }elseif($rep['status'] =='3'){
                      ...
                      <td>
                      <a href="view_report.php?status=view&&id=<?php echo $rep['rep_id'] ?>" type="button" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                      <button type="button" data-bs-toggle="modal" data-bs-target="#verticalycentered" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></button>
