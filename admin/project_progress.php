...
if(isset($_GET['status'])){
    if($_GET['status']=='view'){
       ...
       $prjcon = $obj->display_prjpgrs_con($id);
    }
}
  ...
  <li class="nav-item">
    ...
    <main id="main" class="main">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="row g-3 needs-validation" novalidate action="" autocomplete="" method="POST"
                            ...
                            <div class="col-md-12">
                                ...
                                <input name="task" type="text" class="form-control" id="validationCustom01" value=""
                                    required>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="des" type="text" class="form-control" id="validationCustom02" value=""
                                    required></textarea>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-sm-12">
                                    <select name="staff" class="form-select" aria-label="Default select example">
                                        ...
                                        <option value="<?php echo $st['first_name']." ".$st['last_name'] ?>">
                                            <?php echo $st['first_name']." ".$st['last_name'] ?></option> <?php }?>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group has-validation">
                                    <input name="end" type="date" class="form-control" id="validationCustomUsername"
                    ...
                    <div class="modal-footer">
                        ...
                        <button style="color:#e9e5d6; background-color: #008000; border: none;" name="add_task"
        ...
        <div style="margin-left: 17%;">
            <a href="manage_project.php"><button style="color:#e9e5d6; background-color: #0080c0;" type="button"
...
text-transform: uppercase; font-weight: bold;'> Done </p>";
                        ...
                        <div class="row">
                                                ...
                                                <div id="carouselExampleIndicators" class="carousel slide"
                                                    ...
                                                    <div class="carousel-inner">
                                                        <div class="carousel-item active">
                                                            <img src="project_img/<?php echo $prj['site_pic'] ?>"
                                                                class="d-block w-100" alt="...">

                                                        </div>
                                                        <div class="carousel-item">
                                                            <img src="project_img/<?php echo $prj['site_pic1'] ?>"
                                                                class="d-block w-100" alt="...">
                                                        </div>
                                                        <div class="carousel-item">
                                                            <img src="project_img/<?php echo $prj['site_pic2'] ?>"
                                                                class="d-block w-100" alt="...">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card card-outline card-primary">
                                            <div class="card-header">
                                                ...
                                                <div class="card-tools">
                                                    <button style="color:#e9e5d6; background-color: #008000;"
                                                        type="button" data-bs-toggle="modal"
                                                        data-bs-target="#verticalycentered" class="btn"><i
                                                            class="fa-solid fa-folder-plus"></i> Add Task</button>
                                                </div>
							...
							?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="edit_task.php?status=edit&&taskid=<?php echo $row['id'] ?>"
                                                                        type="button" class="btn btn-warning"><i
                                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                                    <a href="?status=delete&&id=<?php echo $id ?>&&taskid=<?php echo $row['id'] ?>"
                                                                        onclick="return confirm('Are you sure you want to delete this task? NOTE: This action cannot be undone.')"
                    ...
                    <div class="modal fade" id="prjhistory" tabindex="-1">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"><?php echo $mem['first_name']." ".$mem['last_name'] ?>
                                        Payment History</h5>
