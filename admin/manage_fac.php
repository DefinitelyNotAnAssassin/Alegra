...
<?php include('headnav.php')?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>RESERVATION</h1>
            <br>
            <button style="color:#e9e5d6; background-color: #008000;" type="button" data-bs-toggle="modal"
                data-bs-target="#verticalycentered" class="btn"><i class="fa-solid fa-folder-plus"></i> Add
                Reservation</button>
        </div><!-- End Page Title -->
                    ...
                    <div class="row">
                        <div style="text-align: center;" class="col-xxl-3 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">All <span>| Reservation</span></h5>
      ...
      ?>
                        ...
                        <div style="text-align: center;" class="col-xxl-3 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Approved <span>| Reservation</span></h5>
      ...
      ?>
                        ...
                        <div style="text-align: center;" class="col-xxl-3 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Pending <span>| Reservation</span></h5>
      ...
      ?>
                        ...
                        <div style="text-align: center;" class="col-xxl-3 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Disapproved <span>| Reservation</span></h5>
                    ...
                    if($res['status']==2)
                      {
                         ?>
                                                <a href="?status=reject&&id=<?php echo $res['id'] ?>" type="button"
                                                    class="btn btn-danger"  onclick="return confirm('Disapprove this reservation?')"><i class="fa-solid fa-square-xmark"></i></a>
                                                <?php
                    }
                    elseif($res['status']==3){
                      ?>
                                                <a href="?status=approve&&id=<?php echo $res['id'] ?>" type="button"
                                                    class="btn btn-success" onclick="return confirm('Approve this reservation?')"><i
                    ...
                    ?>
                                                <a href="?status=approve&&id=<?php echo $res['id'] ?>" type="button"
                                                    class="btn btn-success"><i
                                                        class="fa-solid fa-check-to-slot" onclick="return confirm('Approve this reservation?')"></i></a>
                                                <a href="?status=reject&&id=<?php echo $res['id'] ?>" type="button"
                                                    class="btn btn-danger" onclick="return confirm('Disapprove this reservation?')"><i class="fa-solid fa-square-xmark"></i></a>
                                                <?php
                    }
