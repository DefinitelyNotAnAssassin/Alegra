              ...
              <div class="card info-card sales-card">
                ...
                <div  class="card-body">
                  ...
                  <div style="margin-left: 25%;" class="d-flex align-items-center">
                    ...
                    <?php
    $sql = "SELECT * from projects WHERE status != 0 AND status != 4 AND status != 10";
        ...
        <div class="card-body" style="overflow-x:auto;">
          ...
          <table id="example" class="table table-hover datatable">
            ...
            <?php
                ...
                $qry = $conn->query("SELECT * FROM projects WHERE status = 1 OR status = 2 OR STATUS = 3 order by deadline desc");
