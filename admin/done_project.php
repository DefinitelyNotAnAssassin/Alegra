        ...
        <div class="card-body">
          ...
          <table id="example" class="table table-hover datatable">
            ...
            <?php
                ...
                $qry = $conn->query("SELECT * FROM projects WHERE status = 5  order by deadline desc");
                ...
                elseif($row['status'] == 0 && strtotime(date('Y-m-d')) > strtotime($row['deadline'])):
                  ...
                  <tr>
                      ...
                      <td>
                      <a href="view_done.php?status=view&&id=<?php echo $row['id'] ?>" type="button" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
